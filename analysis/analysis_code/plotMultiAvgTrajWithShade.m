...
function [] = plotMultiAvgTrajWithShade(traj_names, plt_p, p)
    ...
    for iTraj = 1:length(traj_names)
        ...
        % Plot avg with shade.
        stdshade(avg_each.traj(iTraj).con_left(:,good_subs,1)', plt_p.f_alpha*0.3, plt_p.con_col, subs_avg.traj.con_left(:,3), 0, 0, 'ci', plt_p.alpha_size, plt_p.linewidth);
        stdshade(avg_each.traj(iTraj).con_right(:,good_subs,1)', plt_p.f_alpha*0.3, plt_p.con_col, subs_avg.traj.con_right(:,3), 0, 0, 'ci', plt_p.alpha_size, plt_p.linewidth);
        stdshade(avg_each.traj(iTraj).incon_left(:,good_subs,1)', plt_p.f_alpha*0.3, plt_p.incon_col, subs_avg.traj.incon_left(:,3), 0, 0, 'ci', plt_p.alpha_size, plt_p.linewidth);
        stdshade(avg_each.traj(iTraj).incon_right(:,good_subs,1)', plt_p.f_alpha*0.3, plt_p.incon_col, subs_avg.traj.incon_right(:,3), 0, 0, 'ci', plt_p.alpha_size, plt_p.linewidth);
