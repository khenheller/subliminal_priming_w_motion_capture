function [] = plotTreeBH(plt_p, p)
    ...
    auc_perm_p_val = load([p.PROC_DATA_FOLDER '/auc_perm_p_val_' p.DAY '_' p.EXP '.mat']);  auc_perm_p_val = auc_perm_p_val.p_val;
    com_p_val = load([p.PROC_DATA_FOLDER '/com_p_val_' p.DAY '_subs_' p.SUBS_STRING '.mat']);  com_p_val = com_p_val.p_val;
    ra_perm_p_val = load([p.PROC_DATA_FOLDER '/ra_perm_p_val_' p.DAY '_' p.EXP '.mat']);  ra_perm_p_val = ra_perm_p_val.p_val;
    ...
    node_p_values = [nan,...
        ...
        react_p_val, mt_p_val, com_p_val, tot_dist_p_val, auc_perm_p_val, ra_perm_p_val];
