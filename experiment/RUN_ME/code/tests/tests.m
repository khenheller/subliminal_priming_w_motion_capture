...
function [pass_test, test_res] = tests (trials, trials_traj, input_type, p)
    ...
    if ~strcmp(input_type, 'practice_trials_list')
    ...
    disp('------------------------------- Relations -------------------------------');
    pass_relations.prime_target = relationsTest(cell2mat(trials.prime), cell2mat(trials.target), 'prime_target', input_type, p);
    pass_relations.prime_dist = relationsTest(cell2mat(trials.prime), cell2mat(trials.distractor), 'prime_dist', input_type, p);
